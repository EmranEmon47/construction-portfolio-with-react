...
export const Testimonial = () => {
  return (
    <div className="min-h-screen py-16">
      <h5 className="uppercase text-lg text-center text-black ">
        CLIENT TESTIMONAILS
      </h5>
      <h1 className="text-7xl text-black font-semibold uppercase text-center">
        WHAT THEY ARE SAYING <br /> ABOUT OUR COMPANY
      </h1>
      <div className="flex justify-between items-center gap-12 px-28 py-12">
        <div className="flex flex-col justify-center items-center bg-[#181818] py-4 px-8">
          <div>
